...
import com.example.ronny_xie.gdcp.Fragment.jw2012SyetemFragment.page.jw_choice_page;
...
public class jwFragment extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_jw_login_t);
        initHandler();
        init();
        initBar();
...
//                    Intent intent = new Intent(jwFragment.this, jw_main_page.class);
                    Intent intent = new Intent(jwFragment.this, jw_choice_page.class);
...
//        button = (com.gc.materialdesign.views.ButtonRectangle)findViewById(R.id.fragment03_button);
        button = (Button)findViewById(R.id.fragment03_button);
            ...
            public void onClick(View v) {
                ...
                Thread thread = new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        int b = ConnInterByOkGo.ClickIn(arr,values,handler);
                        if (b == 1) {
