...
public class jwxscj_activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		handler = new Handler();
		ProgressDialogUtil.showProgress(jwxscj_activity.this, "请稍后...");
		jwxscj_activity.this.httpclient = jw_main.httpclient;
		jwxscj_activity.this.user = LoginPage.getUser(jwxscj_activity.this);
		jwxscj_activity.this.value = jw_main.values;
		initView();
		begin();// 开始操作
	}
	...
	private void initView() {
		...
		scrollView = (ScrollView) jwxscj_activity.this
		...
		lv_bixiu = (ListViewForScrollView) jwxscj_activity.this
				.findViewById(R.id.jwxscj_listview_bixiu);
		lv_xuanxiu = (ListViewForScrollView) jwxscj_activity.this
