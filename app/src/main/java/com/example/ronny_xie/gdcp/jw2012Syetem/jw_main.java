...
public class jw_main extends Activity {
    ...
    private static final String TAG = "jw_main";
    @Override
    ...
    private void onClickListener() {
        listview1.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent intent = new Intent(jw_main.this, MywebView.class);
            ...
            public void run() {
                try {
                    ...
                    handler.post(new Runnable() {
                        ...
                        @Override
                        public void run() {
                            ToastUtil.show(jw_main.this, "出现未知错误，请重新认证登录");
                            finish();
                        }
                    });
                    e.printStackTrace();
    ...
    private void initView() {
        httpclient = fragment_jw.httpClient;
        values = fragment_jw.values;
        user = LoginPage.getUser(jw_main.this);
    ...
    private void initClickView() {
        ...
        ib2.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(final View v) {
                // 拿到httpclient配置的信息
                ProgressDialogUtil.showProgress(jw_main.this, "请稍后...");
                Thread thread = new Thread(new Runnable() {
    ...
    private void initSpinnerData() {
        ...
        ArrayAdapter<String> adapter1 = new ArrayAdapter<String>(jw_main.this,
        ...
        Sp2_arr.add("1");
        Sp2_arr.add("2");
        ArrayAdapter<String> adapter2 = new ArrayAdapter<String>(jw_main.this,
    ...
    private void show_jwxs_PopWindow(View v, final int tem) {
        View toolsLayout = LayoutInflater.from(jw_main.this).inflate(R.layout.jwxw_activity_popwindow, null);
        ...
        btn_pop.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent;
                if(tem == 2){
                    intent = new Intent(jw_main.this, jwxskb_activity.class);
                }else{
                    intent = new Intent(jw_main.this, jwxscj_activity.class);
                }
