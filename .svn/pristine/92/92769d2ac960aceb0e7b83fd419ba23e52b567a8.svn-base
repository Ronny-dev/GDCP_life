...
public class jwxscj_page extends Activity {
	...
	private static final String TAG = "jwxscj_page";
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		//jwxscj_page.this.value = jwFragment.values;
		Log.e(TAG, "onCreate: ++++++++++++获取values");
		value = jwFragment.values;
		initView();
		begin();// 开始操作
	}
	...
	private void initDataFromHTML(final String[] data) {
		Thread thread = new Thread(new Runnable() {
			@Override
			public void run() {
	bfromHTML =ConnInterByOkGo.getXSCJfromHTML(value,user[0],data);
	...
	handler.post(new Runnable() {
		...
		private void setVisible() {
			...
			private void getScoreData() {
				...
				Log.e(TAG, "getScoreData: HTML"+bfromHTML);
				Log.e(TAG, "getScoreData: ========="+doc.toString());
				Element elementById = doc.getElementById("Datagrid1");
				Log.e(TAG, "getScoreData:elementById "+elementById.toString() );
				Elements elementsByTag = elementById.getElementsByTag("tr");
				Log.e(TAG, "getScoreData:elementsByTag "+elementsByTag.toString() );
			...
			private void initPersonData() {
				...
				Log.e(TAG, "initPersonData: "+elementByName.toString() );
				Element elementByClass = doc.getElementById("Label8");
				Log.e(TAG, "initPersonData: "+elementByClass.toString() );
				Element elementByXueyuan = doc.getElementById("Label6");
				Log.e(TAG, "initPersonData: "+elementByXueyuan.toString() );
				Element elementByZhuanye = doc.getElementById("Label7");
				Log.e(TAG, "initPersonData: "+elementByZhuanye.toString() );
