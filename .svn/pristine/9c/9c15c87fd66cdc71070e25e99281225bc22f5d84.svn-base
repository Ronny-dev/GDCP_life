...
public class MessageListAdapter extends BaseAdapter {
	...
	public MessageListAdapter(com.example.ronny_xie.gdcp.Fragment.messageFragment messageFragment, List<GotyeChatTarget> sessions) {
	...
	public int getItemViewType(int position) {
		...
		if (t.getName().equals(com.example.ronny_xie.gdcp.Fragment.messageFragment.fixName)) {
			return 0;
		} else {
			return 1;
		}
	...
	public View getView(int arg0, View view, ViewGroup arg2) {
		...
		if (getItemViewType(arg0) == 0) {
			...
			viewHolder.icon.setImageResource(R.drawable.message_noticelist);
