...
public class libFragment extends android.support.v4.app.Fragment{
    ...
    private void initViews(View v) {
        v.findViewById(R.id.back).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                MainActivity activityUI = (MainActivity) getActivity();
                activityUI.hideFragment();
            }
        });
    }
    @Override
    ...
    private void initLineChareView() {
        lineChart = (LineChartView) getActivity().findViewById(R.id.fragment_card_linechart);
        //X轴的标注
        date = new String[]{"10-22","11-22","12-22","1-22","6-22","5-23","5-22","6-22","5-23","5-22"};
        //图表的数据点
        score = new int[]{50,42,90,33,10,74,22,18,79,20};
    ...
    private void initLineChart(){
        Line line = new Line(mPointValues).setColor(Color.parseColor("#4169E1"));  //折线的颜色
